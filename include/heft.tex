...
%It's also possible to prove that NON usato
...
where we've used respectively identity \ref{bettidentity} and the expression \ref{gftop} for the number of gauge groups. There is therefore a match with the number of baryonic moduli of the CFT as it was determined by solving the F- and D-term conditions.\\

$\lambda_\sigma$ and $\tau$ instead are dual to the marginal deformations of the CFT, that is of the gauge and superpotential couplings. The $b_3(Y) + 1$ such marginal moduli correspond directly to the $b_3(Y) + 1$ marginal couplings we \cmmnt{finire}
