...
\begin{tabular}{c  c  c}
	...
	$\ssn = 4$ Super-Yang-Mills & $4$ & \raisebox{-.4\height}{\includegraphics[scale=0.2]{4-01}}\\  
	\multicolumn{3}{c}{ $\downarrow$ $\mathbb{Z}_2$ orbifold} \\ 
	$\mathbb{C}^3/\mathbb{Z}_2$ & $2$ & \raisebox{-.4\height}{\includegraphics[scale=0.2]{2-01}} \\ 
	\multicolumn{3}{c}{ $\downarrow$ mass deformation} \\ 
	Klebanov-Witten & $1$ & \raisebox{-.4\height}{\includegraphics[scale=0.2]{1-01}}\\ 
	\multicolumn{3}{c}{ $\downarrow$ $\mathbb{Z}_2$ orbifold} \\ 
	$Y^{2,0}$ & $1$ & \raisebox{-.4\height}{\includegraphics[scale=0.2]{3-01}}\\ 
\end{tabular}
\end{center}
